...
geom_text(data=p50s, position=position_dodge(width=14), size=5, aes(x = 11, y = 0.42, color=steuerjahr, label = paste("p50:",round(exp(p50s$log_income),0))))+
...
geom_text(data=p50s, position=position_dodge(width=16), size=6, aes(x = 11, y = 0.5, color=steuerjahr, label = paste("p50:",round(exp(p50s$log_income),0))))+
